...
public class Cadastro {
	public static void main(String[] args) throws ParseException {
		...
		List<Funcionario> totalFuncionario = funcionarios.stream()
				.filter(funcionario -> funcionario.getSetor().getCodigo() == respCodSetor).collect(Collectors.toList());

		System.out
				.println("Quantidades de funcionarios no setor " +  respCodSetor + ": " + totalFuncionario.size() + " funcionarios -- descricao: " + setor.getDescricao(respCodSetor));
